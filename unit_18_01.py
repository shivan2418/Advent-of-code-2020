...
assert calculate_total('1 + 2 * 3 + 4 * 5 + 6')==71
assert calculate_total('1 + (2 * 3) + (4 * (5 + 6))') == 51
assert calculate_total('2 * 3 + (4 * 5)')==26
assert calculate_total('5 + (8 * 3 + 9 + 3 * 4 * 3)')==437
assert calculate_total('5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))')==12240
assert calculate_total('((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2')==13632
